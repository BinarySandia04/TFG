...
\begin{defi}
 Un \mathbb{tensor} de ordre $n$ es una matriu (o array) multidimensional $T \in \mathbb{R}^{I_1 \times \dots \times I_n}$ amb $I_1, \dots, I_n \in \mathbb{N}$.
...
\caption{
    Representació diagramàtiques de tensors $A,B,C$ d'ordres $1,2$ i $3$ respectivament
}
\end{center}
\label{fig:tensor_not}
\end{figure}

TODO: Parlar aqui sobre contraccions i dibuixar el diagrama
